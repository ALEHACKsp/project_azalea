...
TEST(DataStructuresTest, Strings1)
{
  ...
  ASSERT_EQ(string_a.find("NOOO"), kl_string::npos);
  ASSERT_EQ(string_a.find("world."), kl_string::npos);
  ASSERT_EQ(string_a.find("Hello cruel world I hate everything"), kl_string::npos);

  ASSERT_EQ(string_a.find_last("el"), 9);
  ASSERT_EQ(string_a.find_last("NOOO"), kl_string::npos);
  ASSERT_EQ(string_a.find_last("Hello cruel world I hate everything"), kl_string::npos);
